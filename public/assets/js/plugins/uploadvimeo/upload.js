...
var MediaUploader = function(options) {
  ...
  this.params = this.buildQuery_(options.params);
...
MediaUploader.prototype.complete_ = function() {
  ...
  xhr.onload = function(e) {
    ...
    if (e.target.status < 400) {
      ...
      this.onUpdateMedatada(video_id);
...
/**
 * Update the name and description video
 *
 *
 * @private
 */
MediaUploader.prototype.onUpdateMedatada = function(videoId) {
...
MediaUploader.prototype.buildUrl_ = function(id, params, baseUrl) {
  ...
  if (id) {
    url = 'https://api.vimeo.com/videos/' + id + '/files';
  }
