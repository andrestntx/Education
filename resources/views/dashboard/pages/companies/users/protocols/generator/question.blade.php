<li class="well well-sm" data-id="{{ $question->id }}" data-name="{{ $question->text }}" id="{{ $question->id }}" style="cursor:pointer;">
    <a href="javascript:void(0)" title="Borrar Pregunta" data-toggle="tooltip" class="pull-right question-option btn btn-xs btn-danger"><i class="gi gi-bin" onclick="AppProtocolGenerator.postDeleteQuestion(this)" data-entity-id="{{ $question->id }}"></i></a>
    ...
    <a href="javascript:void(0)" class="editable h4" data-url="/generators/{{ $question->id }}" data-pk="{{ $question->id }}">
        {{ $question->text }}
    </a>
    <ul>
