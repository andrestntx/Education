...
@section('title_page')
	...
	<a href="{{route('formats.checklists.edit', $format)}}" class="btn btn-sm btn-warning" title="Editar formato de chequeo">
					...
					<div class="block">
						<div class="block-title">
							<div class="block-options pull-right">
								{!! Form::open(['route' => ['formats.checklists.questions.create', $format->id], 'method' => 'GET', 'class' => 'form-inline']) !!}
		                        ...
		                        <li title="Pregunta" id="{{ $question->id }}" style="cursor:move">
		                        	<div class="row">
		                            	<div class="col-xs-offset-1 col-xs-10 well">
		                            		<a href="{{ route('formats.checklists.questions.edit', [$format->id, $question->id]) }}"  class="h4" data-toggle="tooltip" title="Editar Pregunta" >
...
@section('js_aditional')
	...
	<script> AppSortable.initChecklists() </script>
@endsection
