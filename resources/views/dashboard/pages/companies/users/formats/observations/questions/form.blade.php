...
@stop
@section('breadcrumbs') {!! Breadcrumbs::render('formats.observations.format.question', $format, $question) !!} @stop
        ...
        @for($i=1; $i <= $number_answers; $i++ )
          <div class="form-group">
            ...
            <div class="col-md-offset-3 col-md-7">      
              {!! Form::textarea('answers['.$i.'][observation]', null, array( 
                'placeholder' => 'Observación '.$i, 'class' => 'form-control', 'rows' => '3')) !!}
            </div>
          </div>
        @endfor
      @else
        @foreach($question->answers as $answer)
            <div class="form-group">
              ...
              <div class="col-md-offset-3 col-md-7">      
              {!! Form::textarea('answers['.$answer->id.'][observation]', $answer->observation, array( 
                'placeholder' => 'Observación ', 'class' => 'form-control', 'rows' => '3')) !!}
            </div>
            </div>
          @endforeach
        @endif
