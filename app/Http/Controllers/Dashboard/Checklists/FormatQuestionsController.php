...
class FormatQuestionsController extends Controller
{
    ...
    private static $prefixRoute = 'formats.checklists.questions.';
    ...
    {
        return redirect()->route('formats.checklists.show', $format_id);
    }
    ...
    public function store(CreateRequest $request, $format_id)
    {
        ...
        return redirect()->route('formats.checklists.show', $this->format->id);
    }
